@php
  ...
  $item = App\Models\Event::where('slug', $slug)->firstOrFail();
...
@section('content')
  <div class="bg-white min-h-screen font-sans">
    ...
    <nav
      ...
      <a href="/portofolio/event" class="flex items-center gap-2 group">
        <div
        ...
        @foreach ($photos as $photo)
          <div class="break-inside-avoid relative group cursor-crosshair">
            ...
            @if (!empty($photo['description']))
              <div
                class="mt-3 px-2 flex justify-between items-start">
