@php
  $gallery = App\Models\Gallery::orderBy('title', 'asc')->get();
@endphp
    ...
    <main class="max-w-6xl mx-auto pb-20 pt-28 relative z-10 px-4 lg:px-0">
      <div class="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-6">
        <div>
          ...
          <h1 class="text-5xl md:text-8xl -ml-1.5 font-light tracking-tighter">KALEIDOSKOP<br><span
              class="font-black text-orange-600">SURVEY</span></h1>
        </div>
      </div>
      ...
      <div class="grid grid-cols-12 gap-4">
        @foreach ($gallery as $item)
          ...
          <a href="/portofolio/kaleidoskop-survey/{{ $item->slug }}"
