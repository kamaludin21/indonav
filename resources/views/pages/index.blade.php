...
@section('content')
    ...
    <div class="w-full h-auto border-b-2 bg-topo">
        ...
        <div class="max-w-screen-lg px-2 lg:px-0 mx-auto py-16 flex">
            ...
            {{-- <div class="animate-rotate-y-3d w-1/3">
                <img src="{{ asset('img/indonav_brand.png') }}"
                    class="h-32 w-32 object-cover backface-hidden" />
            </div> --}}

            {{-- <img src="{{ asset('img/id.svg') }}" class="bg-cover h-1/2 w-auto right-0 bottom-0 lg:bottom-1/3 absolute z-0 opacity-60" alt=""> --}}
    ...
    <hr>
    <div class="grid gap-14 px-2 lg:px-0 py-16 max-w-screen-lg mx-auto">
        ...
        @foreach ($chunks as $index => $chunk)
            ...
            <div class="h-36 w-full overflow-hidden" id="slidable-content-{{ $index + 1 }}">
                <div class="relative h-auto w-full">
                            ...
                            @foreach ($chunk as $item)
                                <li
                                    ...
                                    <a href="{{ $item->url ?? '#' }}" target="_blank"
                                        ...
                                        <img class="h-10 sm:h-12 md:h-14 object-contain"
                    ...
                    <div
                        class="absolute hidden md:block right-0 top-0 z-40 h-full w-24 bg-gradient-to-l from-white to-transparent">
                    </div>
                </div>
            </div>
        @endforeach
