...
@section('content')
  <div class="h-14"></div>
  {{-- Section 3 --}}
  <div class="max-w-screen-lg px-6 lg:px-0 mx-auto py-32">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">

      <div class="">
        <img src="{{ asset('storage/' .$sites['contact-image']?->image) }}"
      ...
      <div class="grid grid-cols-1 gap-6 border-l border-slate-200 pl-0 pl-4 md:pl-12">
        <div class="lg:col-span-1">
          <h2 class="text-4xl font-extrabold text-slate-700 tracking-tight">
            Informasi Kontak
          </h2>
        </div>
        <div class="pt-6 border-t border-slate-100">
          ...
          <a href="tel:{{ strip_tags($sites['phone']?->description) }}"
            class="text-lg font-medium text-slate-700 hover:text-blue-700 transition-colors duration-200">
        ...
        <div class="pt-6 border-t border-slate-100">
          ...
          <a href="mailto:{{ strip_tags($sites['email']?->description) }}"
            class="text-lg font-medium text-slate-700 hover:text-blue-700 transition-colors duration-200 break-words">
