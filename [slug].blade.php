@php
  ...
  $industry = App\Models\Industry::find($product->industry_id);
    ...
    <div class="max-w-6xl px-2 lg:px-0 mx-auto py-16 relative z-10">
      <div class="flex gap-4 md:gap-0 flex-wrap justify-between items-center relative">
        ...
        <div class="relative z-10 order-1 md:order-2 flex justify-center w-full md:w-fit">
          <!-- Background Element (Glow Effect) -->
          ...
          <img src="{{ asset('storage/' . $product->image_product) }}"
            class="relative w-5/6 md:w-72 h-auto drop-shadow-2xl" alt="{{ $product->title }}">
        </div>
      </div>
    </div>
  </div>
